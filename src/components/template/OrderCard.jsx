...
<div className="flex justify-center items-center mb-8">
 {
  isAdmin? "" : <button onClick={handleAddToCart}  className="btn hover:scale-110 scale-100 transition-all duration-500 btn-outline px-12 text-xl font-medium border-0 text-black hover:text-amber-500 bg-transparent border-t-4 hover:bg-transparent border-black border-t-transparent hover:border-amber-500 border-b-4">Add To Cart</button>
 } 
