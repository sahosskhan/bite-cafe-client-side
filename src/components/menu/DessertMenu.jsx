...
import img1 from '../../../assets/menu/dessert-bg.jpg'
...
const DessertMenu = ({menu}) => {
    const item = menu.filter(index => index.category.includes('Dessert'));
    return (
        <div className="mt-16" >
        <Parallax blur={{ min: -30, max: 30 }} bgImage={img1} bgImageAlt="menu banner" strength={200}>
        <MenuBanner banner={{ title: 'Dessert'}}></MenuBanner>
        </Parallax>
